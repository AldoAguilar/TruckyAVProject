...
void controlActuators()
{
  ...
  */
  void ackermann_cmd_cb( const ackermann_msgs::AckermannDrive& ackermann_cmd)
  {
    ...
    */
    void pid_gains_cb( const custom_msgs::PIDGains& pid_gains) // **
    {
      KP = pid_gains.kp;
      KD = pid_gains.kd;
      KI = pid_gains.ki;
  ...
  */
  void actuators_cmd_cb( const custom_msgs::ActuatorsState& actuators_cmd)
  {
...
*/
  ...
  #if PID_ADJUST == true
    ros::Subscriber<custom_msgs::PIDGains> pid_gains_sub("/pid_gains", &pid_gains_cb); // **
  #endif
#else
  ros::Subscriber<custom_msgs::ActuatorsState> actuators_cmd_sub("/actuators_cmd", &actuators_cmd_cb);
#endif
