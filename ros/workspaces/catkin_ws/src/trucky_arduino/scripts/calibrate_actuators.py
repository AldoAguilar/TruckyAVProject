...
from custom_msgs.msg import ActuatorsState
...
def ackermannStateCallback(data):
    global speed
...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/arduino_sensors/actuators_state", ActuatorsState, actuatorsStateCallback)
    rospy.Subscriber("/arduino_sensors/ackermann_state", AckermannDrive, ackermannStateCallback)

    actuators_state_pub = rospy.Publisher("/arduino_actuators/actuators_cmd", ActuatorsState, queue_size=10)
